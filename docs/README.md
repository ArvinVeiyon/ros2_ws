...
| [`rc_configuration.md`](rc_configuration.md) | **RC input + UAVCAN ESC output, as read off the FC (2026-09-04)** — channel map, ch2 calibration and why `RC2_TRIM==RC2_MIN` is a QGC artefact PX4 corrects, the measured stick→throttle table, and ⛔ **why `UAVCAN_EC_MIN/MAX` are 110/8082 and must not be "tidied" back to 10/8191** |
