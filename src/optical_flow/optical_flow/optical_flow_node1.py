...
class OpticalFlowNode(Node):
    def __init__(self):
        ...
        self.cap = cv2.VideoCapture('/dev/video2')  # Adjust the device path for your camera
    ...
    def gyro_callback(self, msg):
        # Update gyro data from the FMU (SensorCombined message)
        self.gyro_data = msg.gyro_rad  # This is the angular velocity in radians per second
    ...
    def publish_optical_flow(self):
        ...
        # Use the gyro data from the FMU for delta_angle
